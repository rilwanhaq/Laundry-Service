...
function Summary(props) {
    ...
    const subTotalsum = Price.reduce((a, b) => a + b, 0);
        ...
        <div className='popup-box'>
             <div className='summary__box'>
                ...
                <div className='summary__order'>
                    ...
                    {products.map((product, index) => {
                            ...
                            <tr>
                                ...
                                <td style={{ fontWeight: "bold" }}>{subTotalsum}</td>
                            </tr>
                            <tr>
                                <td /><td /><td></td>
                                <td>Pickup Charges:</td><td></td>
                                <td style={{ fontWeight: "bold" }}>90</td>
                            </tr>
                            <tr className='product__total'><td /><td /><td></td>
                                <td>
                                    Total:
                                </td>
                                <td></td>
                                <td>RS {subTotalsum + 90}</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                ...
                <div className='summary__footer'>
                 <button className="cancel__button" onClick={handleCancelClick}>Cancel order</button>
                </div>
